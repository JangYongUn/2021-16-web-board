...
-- jangyongun 데이터베이스 구조 내보내기
CREATE DATABASE IF NOT EXISTS `jangyongun` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `jangyongun`;

-- 테이블 jangyongun.auth 구조 내보내기
...
CREATE TABLE IF NOT EXISTS `board` (
  ...
  PRIMARY KEY (`id`),
  KEY `uid` (`uid`),
  CONSTRAINT `FK_board_auth` FOREIGN KEY (`uid`) REFERENCES `auth` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- 내보낼 데이터가 선택되어 있지 않습니다.

-- 테이블 jangyongun.board_ip 구조 내보내기
...
-- 테이블 jangyongun.gallery 구조 내보내기
CREATE TABLE IF NOT EXISTS `gallery` (
  ...
  CONSTRAINT `gallery_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `auth` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC;

-- 내보낼 데이터가 선택되어 있지 않습니다.

-- 테이블 jangyongun.gallery_file 구조 내보내기
...
-- 테이블 jangyongun.gallery_ip 구조 내보내기
...
-- 테이블 jangyongun.sessions 구조 내보내기
